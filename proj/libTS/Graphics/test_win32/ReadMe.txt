================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: test_win32 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した test_win32 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには test_win32 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
test_win32.h
   ...
   Ctest_win32App アプリケーション クラスを宣言します。

test_win32.cpp
   これは、アプリケーション クラス Ctest_win32App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\test_win32.ico
   ...
   アイコンはメイン リソース ファイル test_win32.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、test_win32.rc ファイル内
...
StdAfx.h, StdAfx.cpp
   ...
   test_win32.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
