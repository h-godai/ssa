...
#ifndef APP_WfObjEXPORTER_HPP
#define APP_WfObjEXPORTER_HPP
...
namespace app {
  ...
  class WfObjExporter : public Exporter {
  public:
    virtual ~WfObjExporter(){}


    // ƒrƒ‹1ŒÂ‚ðWfObj‚Éo—Í‚·‚é
