// BoundaryBoxBuilding.hpp
//
// 建築物のバウンダリボックス
//
//
#ifndef APP_BoundaryBoxBuilding_HPP
#define APP_BoundaryBoxBuilding_HPP
...
namespace app {
  ...
  public:
    ...
    BoundaryBoxBuilding(float64_t x = 0.0, float64_t y = 0.0)
...
//        throw GObjException("Building3D::deserialize");
    ...
    // 2D画像からテクスチャを切りだす
    virtual bool makeTexture(ImageBufferARGB::ptr /*mapImg*/, const RectVector2D& /*mapRect*/, MapDirection /*mapDir*/) { return false; }
