================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MapObjectCreatorWinApp プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MapObjectCreatorWinApp には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MapObjectCreatorWinApp アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

MapObjectCreatorWinApp.vcproj
...
MapObjectCreatorWinApp.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   MapObjectCreatorWinApp アプリケーション クラスを宣言します。

MapObjectCreatorWinApp.cpp
   これは、アプリケーション クラス MapObjectCreatorWinApp を含むメイン アプリケー
   ション ソース ファイルです。

MapObjectCreatorWinApp.rc
...
res\MapObjectCreatorWinApp.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル MapObjectCreatorWinApp.rc に含まれていま
   す。

res\MapObjectCreatorWinApp.rc2
...
StdAfx.h, StdAfx.cpp
   ...
   MapObjectCreatorWinApp.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
...
MapObjectCreatorWinApp.manifest
