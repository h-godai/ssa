...
#define int8_t_C(x)         x
#define Uint8_t_C(x)        x
#define INT16_C(x)        x
#define UINT16_C(x)       x
#define int32_t_C(x)        x
#define Uint32_t_C(x)       x##u
#define int64_t_C(x)        x##i64
#define Uint64_t_C(x)       x##ui64
...
#define int64_t_MIN         (-9223372036854775807-1)
